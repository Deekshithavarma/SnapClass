...
def teacher_dashboard():
    ...
    with c2:
        st.subheader(f"""Welcome back, {teacher_data['name']}!""", text_alignment='center')
        ...
        if st.button('Run Face Analysis', width='stretch', type='secondary', icon=':material/analytics:', disabled=not has_photos):
            ...
            with st.spinner('Deep scanning classroom photos..'):
                ...
                if not enrolled_students:
                    st.warning("No students to enroll in this course")
...
def teacher_tab_attendance_records():
    ...
    for r in records:
        ...
        data.append({
            ...
            'Time':datetime.fromisoformat(ts).strftime('%Y-%m-%d %I:%M:%S %p') if ts else "N/A",
...
def teacher_screen_login():
     ...
     teacher_username= st.text_input("Enter Username", placeholder="Enter your text here..")
     teacher_password=st.text_input("Enter password", type='password',placeholder="Enter your password here..")
...
def teacher_screen_register():   
    ...
    teacher_pass=st.text_input("Enter password", type='password',placeholder="Enter your password here..")

    teacher_pass_confirm= st.text_input("Confirm your password", type='password',placeholder="Enter your password here..")
